...
const files = [
  "src/content/core.js", "src/content/diagnostics.js", "src/content/site-adapters.js",
  "src/content/text-engine.js", "src/content/dev-overlay.js", "src/content/content.js",
  "src/background/background.js", "src/options/options.js", "src/popup/popup.js"
];
...
for (const path of ["README.md", "LICENSE", "PRIVACY.md", "SECURITY.md", "CONTRIBUTING.md", "src"]) {
